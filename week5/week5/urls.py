...
urlpatterns = [
    ...
    path('theme/<int:theme_id>/edit/', theme.views.edit, name="edit"),
    path('theme/<int:theme_id>/remove/', theme.views.remove, name="remove"),
    path('theme/<int:theme_id>/detail/', theme.views.detail, name="detail"),
    path('theme/<int:theme_id>/commentedit/<int:pk>/', theme.views.commentedit, name="commentedit"),
